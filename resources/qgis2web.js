...
map.getView().fit([234543.219297, 6247562.066099, 356391.221563, 6329255.613073], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa dos hidrantes de Santa Vitória do Palmar e Chuí</h2>';
        return titleElement;
    })(),
